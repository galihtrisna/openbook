...
<div>
                ...
                <div class="my-[70px]">
                    ...
                    <p class="text-base text-[#767676] leading-7">
                        Explore our new books and get <br>
                        the better insight for your life
                    </p>
                </div>
                <form class="w-[370px]" action="{{ route('register') }}" method="post" >
                    @csrf
                    <div class="flex flex-col gap-6">
                        <div>
                            <label class="text-base block mb-2">Name</label>
                            <input type="name" name="name"
                                class="rounded-2xl bg-form-bg py-[13px] px-7 w-full focus:outline-alerange focus:outline-none @error('name') is-invalid @enderror"
                                placeholder="Name"
                                value="{{ old('name') }}" />
                                @error('name')
